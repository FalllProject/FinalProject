  ...
  <html lang="en">
    ...
    <style scoped>
      ...
      .content-4-1 .btn-fill {
        ...
        background-image: linear-gradient(rgb(203, 91, 91),
            rgb(194, 39, 39));
    ...
    <div class="content-4-1 d-flex flex-column align-items-center h-100 flex-lg-row"
      ...
      <div class="position-relative d-none d-lg-block h-100 width-left">
        <img class="position-absolute img-fluid centered"
          src="C:\Users\anakp\Downloads\logo-lezatoz.png"
          alt style="" width="400 px"/>
      </div>
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          <div class="align-items-center justify-content-center d-lg-none d-flex">
            <img class="img-fluid" 
              src="C:\Users\anakp\Downloads\logo-lezatos.png"
              alt style="" width: 500px;/>
          </div>
          <h3 class="title-text">Masuk Ke Akunmu</h3>
          <p class="caption-text">
            Silahkan login ke akun yang anda punya<br />
            dan terdaftar di Lezatoz
          </p>
          <form style="margin-top: 1.5rem" action="aksi.php" method="POST">
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input class="input-field border-0" type="text" name="username" id="username" placeholder="Masukan Username Anda"
            ...
            <button class="btn btn-fill text-white d-block w-100" type="submit" name="login" id="login">
              Login
            </button>
