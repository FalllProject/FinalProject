...
if ($namaBarang == "") {
    ...
    if (in_array($ekstensi, $valid_ekstensi)) {
        ...
        if ($ukuran < 1000000) {
            ...
            $query = mysqli_query($connection, "INSERT INTO produk (id, namaBarang, harga, deskripsi, gambar) VALUES (NULL, '$namaBarang', '$harga', '$deskripsi', '$gambar')");
            if ($query) {
                echo "Berhasil disimpan<br/>";
                echo "Nama: $namaBarang <br/> <img src='$direktori$gambar' height='200'><br/>";
                echo "Berhasil disimpan.<br/><a href='tampil_foto.php'>Lihat Halaman Berikutnya</a>";
            } else {
